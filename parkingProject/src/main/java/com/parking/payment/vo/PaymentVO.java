...
public class PaymentVO {
	...
	public String getCardValid1() {
		return cardValid1;
	}

	public void setCardValid1(String cardValid1) {
		this.cardValid1 = cardValid1;
	}
	...
	// 결제 페이지 입력 생성자
	public PaymentVO(String cardCompany, String cardNum, String cardValid, String cardCvc, int paymentPolicy) {
		super();
		this.cardCompany = cardCompany;
		this.cardNum = cardNum;
		this.cardValid = cardValid;
