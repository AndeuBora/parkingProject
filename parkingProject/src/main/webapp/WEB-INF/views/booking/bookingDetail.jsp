...
<body>
	...
	<div id="bookingDetail_2">
		...
		<div id="booking_caution">
			<label>감면혜택없음<input type="radio" name="selectBookingDiscount"
	...
	<div id="bookingDetail_3">
		...
		<table border="1">
			...
			<tr>
				<td>요금감면혜택 금액</td>
				<td><span id="bookingDiscountMoney"
			...
			<tr>
				<td>총 결제금액</td>
				<td><span id="totalBookingMoney"
					class="bookingMoneyInfo boldfont">30000</span> 원</td>
			</tr>
		</table>
	</div>
		...
		<table border="1">
			...
			<tr>
				<td><p>
					...
					<p>
						3. 예약구매금액은 종일권 기준으로 입 출차가 자유로우나,<br> 예약일자가 지난 후에도 출차를 안 했을 경우
						견인에 대해 동의합니다
