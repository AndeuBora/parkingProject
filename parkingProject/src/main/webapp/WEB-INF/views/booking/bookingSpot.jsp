...
<body>
		<section>
			...
			<div id="choiceSpot">
				...
				<div id="info">
					<label>선택한 날짜 <input value="****-**-**"
						class="redtext only" id="selectdate" name="selectdate" type="text"
						readonly="readonly">
						...
						id="selectmoney" name="selectmoney" type="text"
						readonly="readonly"> 원
					</label>
				</div>
			</div>
			<div id="next">
				<a href="bookingDetail.do">예약하기</a>
			</div>
		</section>
</body>
</html>